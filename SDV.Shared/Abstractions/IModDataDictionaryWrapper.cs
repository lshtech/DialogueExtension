...
{
  public interface IModDataDictionaryWrapper
  {
    ...
    Dictionary<string, NetString> FieldDict { get; }
    string this[string key] { get; set; }
    void SetFromSerialization(StardewValley.ModDataDictionary source);
    StardewValley.ModDataDictionary GetForSerialization();
