...
namespace SDV.Shared.Abstractions
{
  public class ModDataDictionaryWrapper : IModDataDictionaryWrapper
  {
    ...
    public Dictionary<string, NetString> FieldDict { get; }
    ...
    public void SetFromSerialization(StardewValley.ModDataDictionary source)
    {
    }

    public StardewValley.ModDataDictionary GetForSerialization() => null;
