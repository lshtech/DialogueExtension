...
{
  public class GameLocationWrapper : IGameLocationWrapper, IWrappedType<GameLocation>
  {
    public GameLocationWrapper(GameLocation gameLocation) =>
      GetBaseType = gameLocation;
